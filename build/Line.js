...
export class Line {
    ...
    static UnaryOperation(L, operation) {
        return new Line(Point.UnaryOperation(L.p1, operation), Point.UnaryOperation(L.p2, operation));
    }
    /** Returns a new line with an operation applied on both points */
    static BinaryOperation(L1, L2, operation) {
        return new Line(Point.BinaryOperation(L1.p1, L2.p1, operation), Point.BinaryOperation(L1.p2, L2.p2, operation));
    }
    /** Gets the projected point on the line (no overflow, finite line segment). */
    static PointProjection(L, p) {
    ...
    static DistanceToPointAsInfiniteLine(L, p) {
    ...
    static NormalizedScalarPointProjection(L, p) {
